...
i18n_urls = [
    ...
    url(r'^group/user/groups/$', 'zerver.views.groups.get_subscribed_groups'),
    ...
    url(r'^group/messages/(?P<recipient_id>\d*)$', 'zerver.views.groups.get_group_messages'),
